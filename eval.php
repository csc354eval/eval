  ...
  <body>
    ...
    <?php
        ...
        foreach($rubrics as $rubric)
        {
                ...
                print"<br><label>";
                print"<input type ='radio' name=$value value='$zero' onclick='p$
                print"0  </label><label>";
                print"<input type ='radio' name=$value value='$one' onclick='pr$
                print"1  </label><label>";
                print"<input type ='radio' name=$value value='$two' onclick='pr$
                print"2  </label><label>";
                print"<input type ='radio' name=$value value='$three' onclick='$
                print"3  </label>";
        ...
        print"<br><tr><td><label>Comment(s)<input type=\"text\" name=\"email\" $
        //print"<tr><td><a href=\"http://csitrd.kutztown.edu/~mperr017/eval/\">$
        print"</table>";
